...
const SQL_FILES = [
  ...
  { name: 'Migration: Account Balances', path: path.join(__dirname, 'migrations', 'add_account_balances.sql') },
  { name: 'Migration: Mastercard Payment Method', path: path.join(__dirname, 'migrations', 'add_mastercard_payment_method.sql') },
];
